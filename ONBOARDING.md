# Indie Kit Onboarding Guide

## What Is This?

`Indie Kit`은 SaaS 제품을 빠르게 시작하기 위한 `Next.js` 보일러플레이트입니다.
퍼블릭 웹사이트, 인증, 인앱 대시보드, 관리자 영역, 결제/크레딧,
문서/블로그(MDX)까지 기본 구조가 포함되어 있습니다.

핵심 목적은 "아이디어 검증용 SaaS를 짧은 시간 안에 배포 가능한 형태로
올리는 것"입니다. 실제 제품 도메인에 맞게 UI/결제/정책 페이지를 교체해서
사용하는 구조입니다.
...
4. 운영자는 `super-admin` 영역에서 사용자/플랜/쿠폰/메시지를 관리합니다.
