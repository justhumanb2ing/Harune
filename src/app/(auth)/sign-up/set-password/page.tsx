...
import { type SetPasswordInput, setPasswordSchema } from "@/lib/validations/auth.schema";
...
export default function SetPasswordPage() {
  ...
  if (tokenError) {
    return (
      <div className="flex flex-col gap-6">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold tracking-tight mb-2">Invalid Link</h1>
  ...
  return (
    <>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight mb-2">Set Your Password</h1>
