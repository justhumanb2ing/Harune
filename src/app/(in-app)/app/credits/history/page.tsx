...
import { ArrowLeft, Clock, CreditCard, History, Minus, Plus } from "lucide-react";
          ...
          return (
            <Card key={creditType}>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Available {creditType.replace("_", " ")} credits</CardDescription>
              </CardHeader>
            </Card>
          );
        })}
          ...
          {transactions.length === 0 ? (
            <div className="py-12 text-center">
              ...
              <p className="mb-4 text-muted-foreground">
                Your credit transactions will appear here once you make your first purchase or use
                credits.
              </p>
              <Button
                nativeButton={false}
                      ...
                      <TableRow key={transaction.id}>
                        <TableCell>
                          <Badge
                            ...
                            className={cn("flex items-center gap-1 w-fit", typeStyle.className)}
                          >
                            ...
                            {transaction.metadata?.amountPaid && (
                              <div className="mt-1 text-xs text-muted-foreground">
                                ...
                                {formatCurrency(
                                  ...
                                  (transaction.metadata.currency as string) || "USD"
                                )}
                              </div>
                            )}
                          </div>
