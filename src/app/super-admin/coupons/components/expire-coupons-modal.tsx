  ...
  const handleSubmit = async () => {
    ...
    for (let i = 0; i < codes.length; i += batchSize) {
      ...
      try {
        ...
        usersDowngraded += result.usersDowngraded;
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Use this tool to expire coupon codes or mark refunded coupons as expired. This will
            recalculate plans for affected users.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="grid gap-4 py-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Enter one or more coupon codes to expire. Users using these coupons may be
                  downgraded.
                </p>
              </div>
            </div>
            <DialogFooter>
              <Button variant="destructive" onClick={handleSubmit} disabled={!couponCodes.trim()}>
