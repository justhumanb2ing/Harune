...
export default function CouponsPage() {
  ...
  const queryKey = queryKeys.superAdmin.coupons.list({
    page,
    search: debouncedSearch,
    status: statusFilter,
  });

  const { data, isPending } = useQuery<CouponsResponse>({
    queryKey,
    queryFn: ({ signal }) => {
      ...
      return apiFetch(`/api/super-admin/coupons?${params.toString()}`, { signal });
    },
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <ExpireCouponsModal onSuccess={refreshCoupons} />
          <GenerateModal onSuccess={refreshCoupons} />
        </div>
      </div>
