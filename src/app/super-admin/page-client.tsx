...
export default function SuperAdminDashboard() {
  const { data: dailyStats } = useQuery({
    queryKey: queryKeys.superAdmin.stats.daily(),
    queryFn: ({ signal }) =>
      apiFetch<{ data: DailyStats[] }>("/api/super-admin/stats/daily", { signal }),
  });
  const { data: planStats } = useQuery({
    queryKey: queryKeys.superAdmin.stats.plans(),
    queryFn: ({ signal }) =>
      apiFetch<{ data: PlanStats[] }>("/api/super-admin/stats/plans", { signal }),
  });
