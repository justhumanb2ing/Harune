...
import { type PlanFormValues, planFormSchema } from "@/lib/validations/plan.schema";
...
export function PlanForm({ initialData, onSubmit, submitLabel = "Save Plan" }: PlanFormProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Unique identifier for the plan (e.g., &ldquo;pro&rdquo;, &ldquo;basic&rdquo;)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Number of coupons required to activate this plan. Useful for lifetime deals
                    where multiple coupons need to be applied.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
