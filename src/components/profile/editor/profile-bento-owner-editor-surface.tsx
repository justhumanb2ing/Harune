...
import { ProfileBentoOwnerSettingPopover } from "@/components/profile/editor/profile-bento-owner-setting-popover";
import { ProfileBentoProfileEditor } from "@/components/profile/editor/profile-bento-profile-editor";
import { ProfilePageEditorProvider } from "@/components/profile/editor/profile-editor-provider";
import type { ProfileBentoGridPreviewMode } from "@/components/profile/grid/profile-bento-grid-actions";
import { ProfileBentoInteractiveGrid } from "@/components/profile/grid/profile-bento-interactive-grid";
...
const ProfileBentoOwnerAnalyticsViews = dynamic(
  () =>
    import("@/components/profile/analytics/profile-bento-owner-analytics-views").then(
...
export function ProfileBentoOwnerEditorSurface({
  ...
  const sectionClassName = cn(
    "mx-auto flex min-h-lvh w-full flex-col items-center justify-center gap-8 px-6 pb-8 pt-12 [--v2-page-top-offset:3rem] sm:px-16 2xl:px-16 2xl:pt-16 2xl:[--v2-page-top-offset:4rem] min-[1700px]:px-16 min-[1800px]:px-20",
    isCompactSurface
