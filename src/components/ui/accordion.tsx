...
function normalizeAccordionValue(value: AccordionValue): AccordionMultipleValue {
...
function Accordion({
  ...
  const resolvedValue = value === undefined ? undefined : normalizeAccordionValue(value);
  const resolvedDefaultValue =
    defaultValue === undefined ? undefined : normalizeAccordionValue(defaultValue);

  const handleValueChange = React.useCallback(
    (nextValue: AccordionMultipleValue) => {
