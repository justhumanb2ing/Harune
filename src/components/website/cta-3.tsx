        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-4 text-lg text-primary-foreground/80">
              Join thousands of businesses that are saving time and increasing productivity with our
              AI solutions.
            </p>
            ...
            <div className="mt-12">
              <div className="flex items-center gap-4">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-primary-foreground/60">on leading review platforms</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="absolute -bottom-6 -left-6 rounded-3xl bg-background p-6 shadow-xl ring-1 ring-border/10 sm:-bottom-8 sm:-left-8 sm:p-8">
              <div className="grid gap-6 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Increase in productivity</p>
                </div>
                <div>
                  <p className="text-3xl font-bold">30hr</p>
                  <p className="mt-1 text-sm text-muted-foreground">Saved per month</p>
                </div>
              </div>
            </div>
          </div>
