...
const benefits = ["Free 7-day trial", "No credit card required", "Cancel anytime", "24/7 support"];
        ...
        <div className="mx-auto grid max-w-lg gap-8 lg:max-w-none lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Experience the power of AI-driven automation. Join thousands of businesses that are
            ...
            <figure className="mt-12">
              <blockquote className="text-lg font-medium leading-8">
                &ldquo;This platform has completely transformed how we handle our data processing.
                The AI-powered insights have been a game-changer for our business.&rdquo;
              </blockquote>
