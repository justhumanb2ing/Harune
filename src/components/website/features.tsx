...
const tabs = [
  {
    ...
    featureList: (
      <ul className="mt-4 space-y-3">
        <li>
          • <b>Beautiful, responsive email templates</b> design using <code>react-email</code>
        </li>
        <li>
      ...
      <div className="container">
        <div className="mx-auto flex max-w-(--breakpoint-md) flex-col items-center gap-6">
          <h2 className="mb-4 text-center text-4xl font-semibold md:text-5xl">
            ...
            <HyperText startOnView delay={1000} as="span" className="text-primary">
              launch faster
            </HyperText>
            , make $
          </h2>
          <p className="text-center text-lg text-muted-foreground md:text-xl">
            Login users, process payments, send emails at lightspeed. Spend your time building your
            startup, not integrating APIs. <span className="text-primary">Indie Kit</span> provides
            you with the boilerplate code you need to launch,{" "}
                  ...
                  <div className="mb-8">
                    ...
                    <div className="mt-6">
                      <span className="text-sm text-green-500 flex items-center gap-1">
                        ...
                        <span className="font-semibold text-green-500">{tab.timeSaved}</span>
                      </span>
                    </div>
