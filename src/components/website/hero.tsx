          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-16">
            ...
            <div className="flex flex-col justify-center lg:col-span-6">
              ...
              <p className="mt-4 text-lg text-muted-foreground sm:mt-5 sm:text-xl lg:mt-6">
                NextJS 15 boilerplate with all the features you need to build your SaaS, AI, or B2B
                application and get it to market faster.
              </p>
              ...
              <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-muted-foreground">Already using boilerplates</p>
                  </div>
                </div>
