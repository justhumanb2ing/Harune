...
export function ProblemStatement() {
  return (
    <section
      className="py-24 px-4 md:px-6 lg:px-8 bg-background w-full"
        ...
        <Card className="bg-red-200 dark:bg-red-800/50 text-foreground text-left md:text-center border-none w-fit">
          ...
          <CardContent>
            <p className="text-lg mb-4">
              I wanted to build simple apps to launch over the weekend. I was so frustrated
              implementing billing, stripe, auth, quota management, etc. I just gave up.
            </p>
