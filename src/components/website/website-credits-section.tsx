...
import { Coins, Crown, Image, Loader2, type LucideIcon, Video, Zap } from "lucide-react";
...
const CreditPackageCard = ({
  ...
  const { price, isLoading, error, getBuyCreditsUrl } = useBuyCredits(creditType, pkg.credits);
  ...
  return (
    <Card className={`relative ${pkg.popular ? "border-primary shadow-lg scale-105" : ""}`}>
...
export default function WebsiteCreditsSection() {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-background to-muted/20" id="credits">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">AI Credits for Everyone</h2>
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            Get instant access to our AI services with flexible credit packages. No subscription
