...
export function WithWithout() {
  const withProduct: ComparisonItem[] = [
    ...
    },
    {
      ...
      description: "Secure login system and payment processing ready out of the box",
    },
    {
      title: "Background Processing",
      description: "Efficient job queues and scheduled tasks handled automatically",
    },
    {
      title: "SEO Optimization",
      description: "Built-in SEO features, sitemaps, and structured data for better rankings",
    },
    {
      title: "Database & Storage",
      description: "Pre-configured database setup with migrations and file storage solutions",
    },
    {
      title: "Developer Experience",
      description: "Well-documented codebase with TypeScript and best practices implemented",
    },
  ];
  ...
  const withoutProduct: ComparisonItem[] = [
    {
      ...
      description: "Spend weeks building basic components and designing email templates",
    },
    {
      title: "Complex Integrations",
      description: "Struggle with authentication providers and payment gateway setups",
    },
    {
      title: "Manual Processing",
      description: "Build your own job scheduling system and handle background tasks",
    },
    {
      title: "Basic SEO",
      description: "Miss out on important SEO features and struggle with search rankings",
    },
    {
      title: "Database Headaches",
      description: "Deal with database setup, migrations, and storage configuration manually",
    },
    {
      title: "Technical Debt",
      description: "Risk building without proper structure, leading to maintenance issues",
    },
  ];
