...
export default function Welcome({ userName, dashboardUrl }: WelcomeEmailProps) {
  return (
    <Html>
      <Layout previewText={`Welcome to ${appConfig.projectName}, ${userName}! 👋`}>
        <Text>
        ...
        <Container className="ml-4 mt-4">
          <Text className="mb-2">🚀 Here&apos;s what you can do with {appConfig.projectName}:</Text>
        ...
        <Text className="mt-4 text-muted">
          Need help getting started? Reply to this email and our support team will be happy to help!
        </Text>
      </Layout>
    </Html>
  );
