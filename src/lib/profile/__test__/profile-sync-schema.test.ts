      ...
      bento: [
        {
          ...
          content: {
            mediaType: "image",
            url: "https://pub.example.com/tmp/users/user-1/profile/bento/media",
            objectKey: "tmp/users/user-1/profile/bento/preview%3Amedia-1/upload",
            tempObjectKey: "tmp/users/user-1/profile/bento/preview%3Amedia-1/upload",
      ...
      bento: [
        {
          ...
          content: {
            mediaType: "video",
            url: "https://pub.example.com/public/users/user-1/profile/bento/media",
            objectKey: "public/users/user-1/profile/bento/media",
            href: "not-a-url",
            alt: "",
            caption: "",
          },
