...
export const getProfileBentoMediaPublicUrl = getProfileMediaPublicUrl;

export const getProfileMediaObjectKeyFromUrl = (publicUrl: string) => {
  const config = getR2Config();
...
export const getProfileBentoMediaObjectKeyFromUrl = getProfileMediaObjectKeyFromUrl;
...
export const hashProfileMediaBuffer = (buffer: Buffer) =>
  createHash("sha256").update(buffer).digest("hex");

export const hashProfileBentoMediaBuffer = hashProfileMediaBuffer;

export const putProfileMediaObject = async ({
  body,
  contentType,
  objectKey,
}: {
...
export const putTemporaryProfileBentoMediaObject = putProfileMediaObject;
...
export const deleteProfileMediaObject = async (objectKey: string) => {
  const config = getR2Config();
...
export const deleteProfileBentoMediaObject = deleteProfileMediaObject;
