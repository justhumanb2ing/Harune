...
export const planFormSchema = z.object({
  ...
  monthlyPriceAnchor: z.number().min(0, "Monthly anchor price must be non-negative"),
  ...
  yearlyPriceAnchor: z.number().min(0, "Yearly anchor price must be non-negative"),
  ...
  onetimePriceAnchor: z.number().min(0, "One-time anchor price must be non-negative"),
